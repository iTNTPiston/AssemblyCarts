...
import com.tntp.assemblycarts.gui.container.ContainerDetectorMark;
...
public class GuiDetectorMark extends SGui {
    ...
    public GuiDetectorMark(IInventory player, Object tile) {
        super(new ContainerDetectorMark(player, tile), ((IInventory) tile).getInventoryName());
        xSize = 176;
        ySize = 168;
    }
