...
public abstract class EnumGuiHandler implements IGuiHandler {
    ...
    public static void openGuiEntity(EnumGui gui, String mod, EntityPlayer player, World world, int entityID) {
        openGui(gui, mod, player, world, entityID, GUI_ENTITY, GUI_ENTITY);
    }

    public static void openGuiCurrentItem(EnumGui gui, String mod, EntityPlayer player, World world) {
        openGui(gui, mod, player, world, GUI_CURRENT_ITEM, GUI_CURRENT_ITEM, GUI_CURRENT_ITEM);
    }

    public static void openGuiOther(EnumGui gui, String mod, EntityPlayer player, World world, int oGuiID, int oGuiParam) {
